...
export default function ProtocolMultiBarChart({mainnetProtocolData, arbitrumProtocolData, optimismProtocolData, polygonProtocolData, gnosisProtocolData, changeHandler, timeRange}: ProtocolAreaChartProps) {
